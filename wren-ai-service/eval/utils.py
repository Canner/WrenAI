...
from eval import WREN_ENGINE_API_URL
...
def engine_config(
    ...
    if isinstance(engine, WrenEngine):
        raise RuntimeError(
            "DuckDB-backed benchmark bootstrap was removed. Configure eval to use PostgreSQL-backed benchmark targets via wren_ibis."
        )
