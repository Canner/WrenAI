...
if __name__ == "__main__":
    # required:
    # - load env vars (e.g. LANGFUSE_API_KEY, LANGFUSE_API_URL, Engine API URL, etc.)

    # CLI input example will be replaced by the actual input
    path = "eval/dataset/eval_dataset_2024_07_10.toml"

    #
    ## noted: export PYTHONPATH=/path/to/your/project/src:$PYTHONPATH to setup the python path avoid import error
