...
Use SQL sample questions only as intent examples. Do not copy from the user's wording as an identifier unless it is listed in DATABASE SCHEMA or RETRIEVED EXECUTABLE SCHEMA.
"""
