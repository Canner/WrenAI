...
Do not copy table names, column names, aliases, source names, physical names, lineage names, SQL fragments, date expressions, or functions from it. Choose every executable identifier only from DATABASE SCHEMA and every function only from SQL FUNCTIONS.
