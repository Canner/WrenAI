...
*Open-source GenBI: let your AI agents generate, deploy, and govern dashboards from any database — grounded in a context layer they can actually trust, across 20+ data sources.*
