...
export const resolveOptionalPersistedKnowledgeBaseId = (
  runtimeIdentity?: { knowledgeBaseId?: string | null } | null,
  payload?: { knowledgeBaseId?: string | null },
  ...
  if (
    payload &&
    Object.prototype.hasOwnProperty.call(payload, 'knowledgeBaseId')
  ) {
    return payload.knowledgeBaseId ?? null;
  }
