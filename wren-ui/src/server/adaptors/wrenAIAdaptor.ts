...
export class WrenAIAdaptor implements IWrenAIAdaptor {
  ...
  public async generateRecommendationQuestions(
    ...
    const body = {
      ...
      source_sql: input.sourceSql,
      source_chart_type: input.sourceChartType,
      source_chart_title: input.sourceChartTitle,
      source_chart_encodings: input.sourceChartEncodings,
      source_dimension_columns: input.sourceDimensionColumns,
      source_intent_lineage: input.sourceIntentLineage,
      source_measure_columns: input.sourceMeasureColumns,
      source_preview_column_count: input.sourcePreviewColumnCount,
      source_preview_columns: input.sourcePreviewColumns,
      source_preview_row_count: input.sourcePreviewRowCount,
      source_response_kind: input.sourceResponseKind,
