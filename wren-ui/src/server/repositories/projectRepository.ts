...
export interface Project {
  id: number; // ID
  type: DataSourceName; // Project connection type. ex: bigquery, mysql, postgresql, mongodb, etc
  version: string; // Project connection version
...
{
  private jsonTypeColumns = ['connection_info'];
