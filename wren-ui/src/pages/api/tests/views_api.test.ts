...
describe('pages/api/v1/views route', () => {
  ...
  it('creates a runtime-scoped view from a thread response', async () => {
    const handler = (await import('../v1/views/index')).default;
    const req = createReq();
    const res = createRes();
  ...
  it('validates a view name through the REST route', async () => {
    const handler = (await import('../v1/views/validate')).default;
  ...
  it('deletes a runtime-scoped view through the REST route', async () => {
    const handler = (await import('../v1/views/[id]')).default;
    const req = createReq({
      method: 'DELETE',
      query: { id: '8' },
      body: {},
  ...
  it('returns preview data for a runtime-scoped view through the REST route', async () => {
    const handler = (await import('../v1/views/[id]/preview')).default;
    const req = createReq({
      method: 'GET',
      query: { id: '8', limit: '50' },
      body: {},
