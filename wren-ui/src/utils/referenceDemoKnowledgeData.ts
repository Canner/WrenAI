...
export const REFERENCE_WORKSPACE_ALIASES: Array<[RegExp, string]> = [
  [/^demo workspace$/i, '演示工作区'],
];

export const REFERENCE_SNAPSHOT_ALIASES: Array<[RegExp, string]> = [
  [/^local main$/i, '主线快照'],
];

export const REFERENCE_ASSET_ALIASES: Record<
  string,
...
export const REFERENCE_THREAD_TITLE_ALIASES: Array<[RegExp, string]> = [
