...
describe.each([
  ['legacy', '../../pages/api/ask_task/streaming'],
  ['v1', '../../pages/api/v1/asking-tasks/[id]/stream'],
])('%s asking task stream API', (_label, modulePath) => {
  let consoleErrorSpy: jest.SpyInstance;
  const loadHandler = async () => {
    if (modulePath === '../../pages/api/ask_task/streaming') {
      return (await import('../../pages/api/ask_task/streaming')).default;
    }

    return (await import('../../pages/api/v1/asking-tasks/[id]/stream'))
      .default;
  };
