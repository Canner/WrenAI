...
describe('SCIM api routes', () => {
  ...
  it('lists SCIM users', async () => {
    const handler = (
      await import('../../pages/api/scim/v2/[workspaceSlug]/Users/index')
    ).default;
    const req = createReq({
      method: 'GET',
  ...
  it('patches a SCIM group', async () => {
    const handler = (
      await import('../../pages/api/scim/v2/[workspaceSlug]/Groups/[id]')
    ).default;
    const req = createReq({
      method: 'PATCH',
  ...
  it('deletes a SCIM user', async () => {
    const handler = (
      await import('../../pages/api/scim/v2/[workspaceSlug]/Users/[id]')
    ).default;
    const req = createReq({
      method: 'DELETE',
