...
describe('pages/api/v1/connectors routes', () => {
  ...
  it('lists connectors within the active runtime knowledge base', async () => {
    const handler = (await import('../../pages/api/v1/connectors')).default;
  ...
  it('lists connector tables with workspace scope only', async () => {
    const handler = (await import('../../pages/api/v1/connectors/[id]/tables'))
      .default;
    const req = createReq({
      method: 'GET',
  ...
  it('rejects connector detail access when record belongs to another knowledge base', async () => {
    const handler = (await import('../../pages/api/v1/connectors/[id]'))
      .default;
    const req = createReq({
      method: 'GET',
  ...
  it('allows workspace-level connector management routes without a knowledge base scope', async () => {
    const detailHandler = (await import('../../pages/api/v1/connectors/[id]'))
      .default;
    const testHandler = (await import('../../pages/api/v1/connectors/test'))
      .default;
  ...
  it('tests an ad-hoc connector payload inside the active runtime scope', async () => {
    const handler = (await import('../../pages/api/v1/connectors/test'))
      .default;
    const req = createReq({
      method: 'POST',
      body: {
