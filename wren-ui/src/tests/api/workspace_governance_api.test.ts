...
describe('workspace governance api routes', () => {
  ...
  it('creates a service account', async () => {
    const handler = (
      await import('../../pages/api/v1/workspace/service-accounts/index')
    ).default;
    const req = createReq({
      method: 'POST',
  ...
  it('creates an API token for a service account', async () => {
    const handler = (
      await import('../../pages/api/v1/workspace/service-accounts/[id]/tokens')
    ).default;
    const req = createReq({
      method: 'POST',
  ...
  it('creates a workspace identity provider', async () => {
    const handler = (
      await import('../../pages/api/v1/workspace/identity-providers/index')
    ).default;
    const req = createReq({
      method: 'POST',
      query: { workspaceId: 'workspace-1' },
  ...
  it('creates an access review', async () => {
    const handler = (
      await import('../../pages/api/v1/workspace/access-reviews/index')
    ).default;
    const req = createReq({
      method: 'POST',
      query: { workspaceId: 'workspace-1' },
  ...
  it('creates a directory group with a role binding', async () => {
    const handler = (await import('../../pages/api/v1/workspace/groups/index'))
      .default;
    const req = createReq({
      method: 'POST',
      query: { workspaceId: 'workspace-1' },
  ...
  it('updates a directory group membership', async () => {
    const handler = (await import('../../pages/api/v1/workspace/groups/[id]'))
      .default;
    const req = createReq({
      method: 'PATCH',
  ...
  it('creates and revokes a break-glass grant', async () => {
    ...
    const createHandler = (
      await import('../../pages/api/v1/workspace/break-glass/index')
    ).default;
    ...
    const revokeHandler = (
      await import('../../pages/api/v1/workspace/break-glass/[id]')
    ).default;
