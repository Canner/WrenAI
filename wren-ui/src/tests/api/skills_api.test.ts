...
describe('pages/api/v1/skills routes', () => {
  ...
  it('creates a workspace-scoped skill from runtime scope', async () => {
    const handler = (await import('../../pages/api/v1/skills')).default;
    const req = createReq({
      method: 'POST',
      body: {
        name: 'weather_skill',
  ...
  it('lists available workspace runtime skills with runtime metadata', async () => {
    const handler = (await import('../../pages/api/v1/skills/available'))
      .default;
  ...
  it('rejects skill detail access when record belongs to another workspace', async () => {
    const handler = (await import('../../pages/api/v1/skills/[id]')).default;
    const req = createReq({
      method: 'GET',
      query: { id: 'skill-7' },
    });
  ...
  it('lists marketplace catalog skills through REST route', async () => {
    const handler = (await import('../../pages/api/v1/skills/marketplace'))
      .default;
    const req = createReq({ method: 'GET' });
    const res = createRes();
