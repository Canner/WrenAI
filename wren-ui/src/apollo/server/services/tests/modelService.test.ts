...
describe('ModelService relation invariants', () => {
  ...
  it('persists runtime identity fields when creating relations by runtime identity', async () => {
    const {
      service,
      modelRepository,
      modelColumnRepository,
  ...
  it('drops a stale project bridge when persisting canonical runtime-scoped relations', async () => {
    const {
      service,
      modelRepository,
      modelColumnRepository,
