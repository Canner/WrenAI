...
export class ModelResolver {
  constructor() {
    ...
    this.prepareProjectForDeploy = this.prepareProjectForDeploy.bind(this);
  ...
  public async checkModelSync(_root: any, _args: any, ctx: IContext) {
    try {
      ...
      const deployedAfterModelingChanges =
        await this.isLastDeployNewerThanModelingChanges(ctx, id, lastDeploy);
      return deployedAfterModelingChanges
  ...
  private async prepareProjectForDeploy(ctx: IContext): Promise<Project> {
