...
export type AutoGeneratedRelationsQuery = { __typename?: 'Query', autoGenerateRelation?: Array<{ __typename?: 'RecommandRelations', name: string, id: number, relations: Array<{ __typename?: 'Relation', fromColumnId: number, fromModelId: number, toColumnId: number, toModelId: number, type: Types.RelationType, name: string } | null> }> | null };
