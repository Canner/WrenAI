...
export type ApiHistoryQuery = { __typename?: 'Query', apiHistory: { __typename?: 'ApiHistoryPaginatedResponse', total: number, hasMore: boolean, items: Array<{ __typename?: 'ApiHistoryResponse', id: string, apiType: Types.ApiType, threadId?: string | null, headers?: any | null, requestPayload?: any | null, responsePayload?: any | null, statusCode?: number | null, durationMs?: number | null, createdAt: string, updatedAt: string }> } };
...
export type AskShadowCompareStatsQuery = { __typename?: 'Query', askShadowCompareStats: { __typename?: 'AskShadowCompareStats', total: number, withDiagnostics: number, enabled: number, executed: number, comparable: number, matched: number, mismatched: number, errorCount: number, byAskPath: Array<{ __typename?: 'AskShadowCompareBucket', key: string, count: number }>, byShadowErrorType: Array<{ __typename?: 'AskShadowCompareBucket', key: string, count: number }>, trends: Array<{ __typename?: 'AskShadowCompareTrendBucket', date: string, total: number, executed: number, comparable: number, matched: number, mismatched: number, errorCount: number }> } };
 ...
 * });
 */
export function useAskShadowCompareStatsQuery(baseOptions?: Apollo.QueryHookOptions<AskShadowCompareStatsQuery, AskShadowCompareStatsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<AskShadowCompareStatsQuery, AskShadowCompareStatsQueryVariables>(AskShadowCompareStatsDocument, options);
      }
export function useAskShadowCompareStatsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<AskShadowCompareStatsQuery, AskShadowCompareStatsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<AskShadowCompareStatsQuery, AskShadowCompareStatsQueryVariables>(AskShadowCompareStatsDocument, options);
        }
export type AskShadowCompareStatsQueryHookResult = ReturnType<typeof useAskShadowCompareStatsQuery>;
export type AskShadowCompareStatsLazyQueryHookResult = ReturnType<typeof useAskShadowCompareStatsLazyQuery>;
export type AskShadowCompareStatsQueryResult = Apollo.QueryResult<AskShadowCompareStatsQuery, AskShadowCompareStatsQueryVariables>;