...
* `wren-agentic-system`: the AI service. check out example here: [wren-agentic-system docker-compose example](https://github.com/Canner/WrenAI/blob/main/wren-agentic-system/docker/docker-compose.yaml)
